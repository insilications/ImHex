...
Version  : 1.8.1
Release  : 225
URL      : file:///aot/build/clearlinux/packages/ImHex/ImHex-v1.8.1.tar.gz
Source0  : file:///aot/build/clearlinux/packages/ImHex/ImHex-v1.8.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625791168
mkdir -p clr-build
pushd clr-build
